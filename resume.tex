...
\definecolor{russell}{HTML}{2C3E50}
...
\mobile{+49 176 77879262}
\email{moeinierfan79@gmail.com}
%\dateofbirth{January 1st, 1970}
% \homepage{themagicalmammal.vercel.app} 
\github{alpharmike}
\linkedin{erfan-moeini}
% \gitlab{gitlab-id}
...
% PDF metadata
\hypersetup{pdftitle={Erfan Moeini - Resume}, pdfauthor={Erfan Moeini}}
